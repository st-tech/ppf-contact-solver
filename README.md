...
- The paper is first drafted entirely in English in the author's own voice. An LLM is used to proofread and polish the wording, though this iterative process has introduced minor expansions or contractions, all of which are carefully human-checked and corrected where necessary.
