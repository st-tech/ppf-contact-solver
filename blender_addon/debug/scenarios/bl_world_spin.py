# File: scenarios/bl_world_spin.py
# Code: Claude Code
# Review: Ryoichi Ando (ryoichi.ando@zozo.com)
# License: Apache v2.0
#
# Fixed WORLD-axis angular velocity overwrite, through the CUDA-free
# solver's implicit ARAP elastic solver on a no-GPU host.
#
# Companion to bl_angular_spin.py (which spins about a dynamic
...
try:
    ...
    dh.save_blend(PROBE_DIR, "world_spin.blend")
    root = dh.configure_state(
        project_name="world_spin",
