# File: scenarios/bl_sand_roundtrip.py
# Code: Claude Code
# Review: Ryoichi Ando (ryoichi.ando@zozo.com)
# License: Apache v2.0
#
# End-to-end round-trip for the SAND granular type. A closed mesh is
# Converted into a particle mesh (N loose verts seeded inside it), assigned
# to a SAND group, transferred, run, and fetched. Gravity carries every free
# grain down, so the cloud FALLS, which is what separates a real round-trip
# from a run that produced frames without simulating. Asserts:
