# File: scenarios/bl_angular_spin.py
# Code: Claude Code
# Review: Ryoichi Ando (ryoichi.ando@zozo.com)
# License: Apache v2.0
#
# Angular velocity overwrite, exercised end-to-end through the solver's
# elastic step.
#
...
# injects a rigid spin field ω × (x - c) into vertex.prev; the solver
...
#                             advanced clearly, so the override actually
#                             spun the body rather than being ignored.
...
#
# This is the solver-side companion to bl_velocity_keyframes.py (which
