# File: scenarios/bl_lock_translation_pinned.py
# License: Apache v2.0
#
# Affine Lock Translation composition with exact moving pins in the solver.
...
try:
    ...
    root = dh.configure_state(
        project_name="lock_translation_pinned",
