...
| Task                                                                                                                               | Where it lives                                                                                           |
| ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Connect / disconnect / start / stop the remote solver                                                                              | Connection tools (`connect_ssh`, `connect_docker`, `connect_linux_native`, `connect_win_native`, `connect_mac_native`, `disconnect`, `connect`, `start_remote_server`, `stop_remote_server`, ...) |
